...
<body>
	...
	<div id="create-Usuario" class="content scaffold-create" role="main">
		<h1>
			<g:message code="ProjectTracker Login" />
		</h1>
		...
		<g:form action="login">
			<fieldset class="form">
				<div
					...
					<label for="nick"> <g:message code="usuario.nick.label"
				...
				<div
					class="fieldcontain ${hasErrors(bean: usuarioInstance, field: 'contraseña', 'error')} ">
					<label for="contraseña"> <g:message
							code="usuario.contrasenia.label" default="Contraseña" />

					</label>
					<g:field type="password" name="contrasenia"
						value="${usuarioInstance?.contrasenia}" />
				</div>
			</fieldset>
