<html lang="es">
    ...
    <body>
        <div class="nav">
   			  <span class="menuButton"><a class="home" href="/">Inicio</a></span>
     </div>
        <div class="body">
            ...
            <div class="list">
                <table>
                    <thead>
                        <tr>
                            <g:sortableColumn property="files" title="Archivo"/>
                    ...
                    <g:each in="${fileResourceInstanceList}" status="i" var="fileResourceInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td> <label>"/images/${fileResourceInstance.decodeURL()}"</label></td>
                            <td><a href="${createLinkTo( dir:'images' , file: fileResourceInstance.decodeURL(), absolute:true )}" target="_new">Ver</a></td>
                            <td><g:link action="delete" id="${fileResourceInstance.replace('.','###')}" onclick="return confirm('Are you sure?');"> Borrar </g:link></td>
                        </tr>
                    </g:each>
                    </tbody>
                </table>
